...
class CreateAccountDepositControllerIntegrationTest : AbstractIntegrationTest() {
    ...
    private lateinit var request: CreateAccountDepositRequest

    @BeforeEach
    fun setup() {
        accountId = UUID.randomUUID()
        amount = BigDecimal("1000.00")
        request = CreateAccountDepositRequest(amount)
    ...
    @Test
    fun `should create account deposit successfully`() {
    ...
    @Test
    fun `should return bad request when ownerName is less or equal 0`() {

        val request2 = CreateAccountDepositRequest(BigDecimal.ZERO)
